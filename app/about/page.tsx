                ...
                <Item
                    content={
                        <>
                            <></>
                            <p className="my-4">
                                Our goal is to provide newcomers with resources
                                and support for your bitcoin open source
                                development journey. We are here to convince you
                                to contribute to{" "}
                                <a className="text-orange" href="/projects">
                                    bitcoin open source projects
                                </a>
                                . We measure our success by action, not passive
                                consumption of educational materials.
                            </p>
                            <p>
                                There is an oft-repeated sentiment in the
                                community that bitcoin does not need you. While
                                bitcoin is designed to be resilient, we{" "}
                                <span className="font-style: italic">do</span>{" "}
                                need you. Bitcoin needs all the talent and
                                energy it can gather to solve some of the most
                                difficult technical problems of our time.
                    ...
                    content={
                        <>
                            ...
                            <p className="my-4">
                                ...
                                sponsored initiative geared towards developers
                                at the beginning of their bitcoin journey.
                                Chaincode has a{" "}
                                <a
                                    className="text-orange"
