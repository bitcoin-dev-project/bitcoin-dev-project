...
export default function Career() {
    return (
        <div className="min-h-screen bg-[#F6F0E6] font-quicksand text-brand-dark">
            <div className="my-0 flex max-w-7xl flex-col mx-auto">
                <div className="flex flex-col gap-12 lg:flex-row">
                    <div className="order-1 flex w-full flex-col gap-6 lg:w-[300px]">
                        <GetFundedSidebar />
                    </div>

                    <div className="order-2 flex min-w-0 flex-1 flex-col gap-y-12">
                        {/* Title */}
                        ...
                        >
                            ...
                            <p className="font-quicksand text-lg leading-[1.4] lg:text-xl">
                                If you aspire to have professional freedom, work
                                on something that will impact the lives of
                                countless people across the world, write code
                                that will span generations, and collaborate with
                                some of the most gifted developers on the planet
                                to solve some of the hardest technical problems
                                of our age, then you are in the right place.
                            </p>
                        </section>
                        ...
                        >
                            <SectionHeading>
                                Earning a grant for full-time bitcoin open
                                source work
                            </SectionHeading>
                            <div className="flex flex-col gap-4 font-quicksand text-lg leading-[1.4] lg:text-xl">
                                ...
                                <ReadMore>
                                    <p>
                                        ...
                                        funding is not much of a secret. Start
                                        doing the job for free. It establishes
                                        you as a contributor and proves your
                                        motivation. It shows that you are a good
                                        investment. Applicants will have much
                                        more success if they do the work and
                                        then apply. For most jobs, the applicant
                                        is trying to convince the employer that
                                        they are capable of doing the job. But
                                        the job-seeker has no idea what the work
                                        or environment is actually like. In open
                        ...
                        <div
                            id="adam-article"
                            className="scroll-mt-24 rounded-xl border border-brand-gray-100 bg-brand-gray p-2.5"
                        >
                            <div className="rounded-lg border border-dashed border-gray-300 p-2.5">
                                <div className="mb-4 flex items-start gap-1">
                                    ...
                                    <p className="font-quicksand text-2xl italic">
                                        ...
                                        proves your motivation to do the work.
                        ...
                        >
                            <SectionHeading>
                                A simple checklist to help you get ready to
                                apply for funding.
                            </SectionHeading>
                            <FundingChecklist />
                        </section>
                        ...
                        {/* Reporting tip */}
                        <Tip>
                            All grant orgs require you to do some kind of
                            reporting. They are usually monthly or quarterly.
                            Get into the habit of keeping a journal of what you
                            work on so it is easier when it comes time to put
                            together the report. That way, you won&apos;t forget
                            anything that you did, and you won&apos;t be
                            scrambling to find links to your code contributions.
                        </Tip>
                        ...
                        <section className="flex flex-col gap-3">
                            ...
                            <p className="font-quicksand text-lg leading-[1.4] lg:text-xl">
                                Already have a grant but need a place to work?
                                These organizations offer office space and
                                collaborative environments for Bitcoin
                                developers with existing funding.
                            </p>
                        ...
                        <section className="flex flex-col gap-3">
                            ...
                            <p className="font-quicksand text-lg leading-[1.4] lg:text-xl">
                                ...
                                community-backed support, you can launch your
                                own project through Bitcoin-focused crowdfunding
                                platforms.
                            </p>
                        ...
                        >
                            ...
                            <p className="font-quicksand text-lg leading-[1.4] lg:text-xl">
                                ...
                                organizations with a single application. Fill
                                out the form once, select which funding
                                providers to send it to, and submit. Each
                                organization receives a copy of your application
                                and will reach out if interested. Apply today to
                                fast-track your funding.
                            </p>
                        </section>

                        {/* Common Application card */}
                        <div
