...
export const projects = {
  title: "Discover Bitcoin & Lightning FOSS",
  description:
    "It takes some work to go from curiosity to contribution. But that path isn't often laid out clearly. Below are some stepping stones that will help you make your first FOSS contribution - whether in the form of comments, reviews, or writing your own PRs.",
  levels: [
    {
      title: "",
      description:
      ...
      items: [
        ...
        },
        {
          ...
          subTitle: "",
          description: "The Lightning Development Kit (LDK) is a library that allows you to build a lightning node without worrying about implementing low-level logic",
        ...
        },
        {
          ...
          subTitle: "",
          description: "Lightning Network Daemon (LND) is a Golang implementation and the most widely run full node on the Lightning Network. ",
        ...
        },
        {
          ...
          subTitle: "",
          description: "The Core Lightning project is lightweight, highly customizable and standard compliant implementation of the Lightning protocol implementation written in C",
        ...
        },
        {
          title: "Eclair",
          subTitle: "",
          description: "A scala implementation of the Lightning Network, focusing on the mobile use case",
        ...
        },
        {
          title: "Fedimint",
          subTitle: "",
          description: "A modular open source protocol to custody and transact bitcoin in a community context, built on a strong foundation of privacy",
