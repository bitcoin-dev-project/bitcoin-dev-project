...
export const explainerTopics: ExplainerTopic[] = explainersDataJson as ExplainerTopic[]
...
export const getExplainersByDifficulty = (difficulty: string): ExplainerTopic[] => {
