...
const AsideGoTO: React.FC<IGoTO> = ({ selected, allCurriculum, path}) => {
    ...
    return (
        <>
        <div className="flex-col hidden lg:flex top-10 sticky gap-6">
            <aside className="flex-shrink-0 flex flex-col gap-6">
                ...
                {selected !== "career" && <Filters allCurriculum={allCurriculum} path={path} />}
            </aside>
            {selected !== "career" && (
                <div className="flex flex-col font-quicksand gap-1.5 border rounded-lg p-2 border-brand-stroke-on-base">
