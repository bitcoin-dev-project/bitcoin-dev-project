...
const Testimonial: React.FC<ITestimonial> = ({
    ...
    return (
        <div
            className={clsx(
                "sticky z-20 border mb-20 w-full flex flex-col md:min-h-[218px] max-md:!max-w-[85%] !md:max-w-[unset] 2xl:max-w-full mx-auto"
            )}
            style={{
            ...
            <div className="relative rounded-none h-full px-2.5 pt-[30px] pb-2.5 ">
                ...
                <div className="rounded-xl  px-5 py-5 bg-brand-orange h-full">
                    <div className="flex items-start gap-4">
                        ...
                        <p
                            className="font-quicksand text-xl md:text-2xl leading-[1] tracking-[0%]"
                            style={{ color }}
                        >
                            {quote}
                        </p>
                    ...
                    <div className="flex items-center justify-between mt-5">
                        ...
                        >
                            ...
                            <p className="font-quicksand  text-base">{title}</p>
                        </div>
                    </div>
                </div>
            </div>
