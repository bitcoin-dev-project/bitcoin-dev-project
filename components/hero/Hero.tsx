    ...
    return (
        <Container className="pb-16 pt-20 text-center lg:pt-32 bg-white dark:bg-black">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-black-700 dark:text-black-300">
                The Bitcoin Dev Project is the go-to resource for developers to
                get inspired by and learn bitcoin and related technologies to
                kickstart and grow their career in Free and Open Source
                Software.
            </p>
