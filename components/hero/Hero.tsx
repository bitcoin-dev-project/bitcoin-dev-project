...
export function Hero() {
    return (
        <Container className="pb-16 pt-20 max-sm:pb-0 max-sm:pt-0 text-center lg:pt-32 bg-white dark:bg-black min-h-[calc(100vh-64px)] flex flex-col justify-evenly">
            <div>
                <h1 className="mx-auto max-w-4xl font-display text-4xl font-medium tracking-tight text-black-800 dark:text-black-100 sm:text-7xl">
                ...
                <p className="mx-auto mt-6 max-w-2xl text-lg max-sm:text-base tracking-tight text-black-700 dark:text-black-300">
                    The Bitcoin Dev Project is the go-to resource for developers
                    to get inspired by and learn bitcoin and related
                    technologies to kickstart and grow their career in Free and
