                      ...
                      <h3 className="flex items-center">
                        ...
                        {feature.released ? null : (
                          <span className="ml-3 inline-flex items-center gap-x-1.5 rounded-md px-1.5 py-1 text-xs font-normal text-yellow-500 ring-1 ring-inset ring-yellow-600">
                            <svg className="h-1 w-1 fill-yellow-500" viewBox="0 0 6 6" aria-hidden="true">
            ...
            <div className="order-last mt-6">
              <ul
                ...
                className={clsx(
                  ...
                  false ? 'divide-gray-800 text-gray-300' : 'divide-gray-600 text-gray-500 dark:text-gray-400'
                )}
              >
                {feature.checks.map((check) => (
                  <li key={check} className="flex py-2">
                    <CheckIcon
                      className={clsx('h-6 w-6 flex-none', false ? 'text-white' : 'text-cyan-500')}
                    />
                    <span className="ml-4">{check}</span>
                  </li>
                ))}
              </ul>
            </div>
