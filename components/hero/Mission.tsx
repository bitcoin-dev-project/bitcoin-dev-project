  ...
  const features2 = [
    {
      ...
      name: '01 - Study',
      description:
        "Learning Bitcoin is Hard we make it easy for you.",
      href: '/bitcoin-core',
  ...
  return (
    <div className="bg-white dark:bg-black py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-2xl mb-20 lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-orange-600">Why you need this ?</h2>
        ...
        <span className="line-through">NOT</span> FOR EVERYONE !
            ...
            <p className="mt-6 text-lg leading-8 text-black-600 dark:text-black-400">
              Our goal is to provide you with resources and support for your bitcoin open source development journey. We are here to convince you to contribute to bitcoin open source projects.
        ...
        <div className="mx-auto max-w-2xl  lg:max-w-none">
          <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-4">
            {features2.map((feature) => (
              <div key={feature.name} className="flex flex-col items-center p-6 bg-white dark:bg-black rounded-lg border border-black-300 dark:border-black-800">
                <span className="inline-flex items-center gap-x-1.5 rounded-md bg-black-100 dark:bg-black px-2 py-1 text-xs font-light text-black-600 dark:text-black-400 mb-4  border border-black-300 dark:border-black-800">
                  <svg className="h-2 w-2 fill-orange-400 " viewBox="0 0 6 6" aria-hidden="true">
                ...
                <dt className="mb-5 text-3xl font-bold leading-7 text-black dark:text-white flex flex-col items-center text-center">
                  
                </dt>
                <dd className="mt-1 flex flex-auto flex-col items-center text-base leading-7 text-black-600 dark:text-black-400">
                  <p className="flex-auto text-center mb-6">{feature.description}</p>
                  ...
                  >
                    {feature.cta}
                    <div className="bg-white h-8 w-8 text-black inline-flex items-center justify-center rounded-full"> <span> <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 32 32"><path fill="currentColor" d="m18 6l-1.43 1.393L24.15 15H4v2h20.15l-7.58 7.573L18 26l10-10L18 6z"></path></svg></span> </div>
                  </button>
                  </Link>
