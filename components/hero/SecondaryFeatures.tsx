...
const features: Array<Feature> = [
...

  {
    name: 'Bitcoin TLDR',
    description:
      'Bitcoin-dev and Lightning-dev mailing list summaries',
    summary:
      '',
  ...
  },
  {
    name: 'Saving Satoshi',
    description:
      'Game designed to inspire you fall in love with bitcoin',
    summary:
      '',
    ...
    >
      ...
      <h3
        className={clsx(
          ...
          isActive ? 'text-orange-500' : 'text-black-950 dark:text-black-50',
        )}
      >
        {feature.name}
      </h3>
        ...
        {features.map((feature, featureIndex) => (
          <Feature
            ...
            className={`relative p-4 ${
              featureIndex === selectedIndex ? 'bg-gray-200 dark:bg-gray-800' : 'hover:bg-gray-200 dark:hover:bg-gray-800'
            }`}
          />
        ))}
      </TabList>
