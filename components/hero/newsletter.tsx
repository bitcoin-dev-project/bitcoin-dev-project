            ...
            <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
              <div className="flex flex-col items-start">
                <div className="rounded-md dark:bg-black/5 p-2 ring-1 ring-white/10">
                  <CalendarDaysIcon className="h-6 w-6 text-black dark:text-white" aria-hidden="true" />
                </div>
              ...
              <div className="flex flex-col items-start">
                <div className="rounded-md dark:bg-black/5 p-2 ring-1 ring-white/10">
                  <HandRaisedIcon className="h-6 w-6 text-black dark:text-white" aria-hidden="true" />
                </div>
