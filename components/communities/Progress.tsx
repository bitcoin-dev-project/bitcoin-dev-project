...
export const Progress = ({ community }: { community: Community }) => {
    ...
    return (
        <div className="flex flex-col gap-4 bg-brand-card/80 dark:bg-gray-800/40 rounded-xl p-4 border border-brand-gray-100 dark:border-gray-700/50">
            <div className="space-y-1">
                ...
                <div className="w-full bg-brand-gray-100 dark:bg-gray-700 rounded-full h-2">
                    <div
