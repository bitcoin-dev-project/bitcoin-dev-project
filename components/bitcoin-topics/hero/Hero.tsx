...
const ContinueReadingComp: React.FC<{
    ...
    return (
        <div className="min-h-screen overflow-hidden flex items-center justify-center bg-gradient-to-br from-vscode-background-light to-vscode-background-light dark:from-vscode-background-dark dark:to-vscode-background-dark">
