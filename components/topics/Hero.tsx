...
export function Hero() {
  return (
    <div className="w-full" style={{ width: '100vw', marginLeft: 'calc(-50vw + 50%)', marginRight: 'calc(-50vw + 50%)' }}>

    <div className="overflow-hidden bg-slate-900 dark:-mb-32 dark:mt-[-4.75rem] dark:pb-32 dark:pt-[4.75rem]" style={{ maxWidth: 'none' }}>
          ...
          <div className="relative z-10 mdd:text-center lgg:text-left">
            ...
            <div className="relative">
              ...
              <p className="mt-3 text-2xl tracking-tight text-slate-400">
                From the basics to advanced concepts, BDP Learn is your all-in-one Bitcoin education center.
              </p>
              <div className="mt-8 flex gap-4 mdd:justify-center lgg:justify-start">
                <Button href="/topics/sample-topic">Get started</Button>
                <Button href="https://github.com/jrakibi/glossary" variant="secondary">
                  View on GitHub
                </Button>
              </div>
            </div>
