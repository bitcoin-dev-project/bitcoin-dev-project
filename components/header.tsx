        ...
        <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
          ...
          <Link href="/">
            <h1 className="text-2xl md:text-xl font-bold">
              The&nbsp;<span className="text-orange-500">Bitcoin</span>&nbsp;Dev
              Project
            </h1>
          </Link>
        </div>
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12 items-center">
          <Popover>
            <PopoverButton className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-800 dark:text-gray-100">
              Learn
              <ChevronDownIcon className="h-5 w-5 flex-none text-gray-400 dark:text-gray-600" aria-hidden="true" />
            </PopoverButton>
            ...
            >
                <PopoverPanel className="absolute inset-x-0 top-0 -z-10 bg-gray-50 dark:bg-black-800 pt-14 shadow-lg ring-1 ring-gray-800/5">
                  ...
                  {products.map((item) => (
                    <div key={item.name} className="group relative rounded-lg p-6 text-sm leading-6 hover:bg-gray-100 dark:hover:bg-black-900 ">
                      <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-gray-100 dark:bg-orange group-hover:bg-white dark:group-hover:bg-black-900">
                        <item.icon className="h-6 w-6 text-gray-600 dark:text-black-800 group-hover:text-orange-600" aria-hidden="true" />
                      </div>
                      <Link href={item.href} >
                  ...
                  <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-1 divide-x divide-gray-800/5 border-x border-gray-800/5">
                      {callsToAction.map((item) => (
                        ...
                        >
                          <item.icon className="h-5 w-5 flex-none text-gray-400 dark:text-gray-600" aria-hidden="true" />
                          {item.name}
                        </a>
                      ))}
                    </div>
          ...
          <Popover>
            ...
            <a href="/career" className="text-sm font-semibold leading-6 text-gray-800 dark:text-gray-100">
            Career
          </a>

            <a href="/tools" className="text-sm font-semibold leading-6 text-gray-800 dark:text-gray-100">
            Tools
          </a>
            <a href="/about" className="text-sm font-semibold leading-6 text-gray-800 dark:text-gray-100">
            About
          </a>
        <ThemeToggle />
                ...
                <Disclosure as="div" className="-mx-3">
                  {({ open }) => (
                    <>
                      ...
                      <DisclosurePanel className="mt-2 space-y-2">
                        {[...contributions, ...callsToAction].map((item) => (
                          <DisclosureButton
                            key={item.name}
                            as="a"
                            href={item.href}
