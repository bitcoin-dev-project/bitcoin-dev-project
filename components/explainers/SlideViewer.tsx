...
import { ChevronLeft, ChevronRight, X, Download, Share, ZoomIn, ZoomOut } from "lucide-react"
...
export default function SlideViewer({ topic, isOpen, onClose, initialSlideIndex = 0 }: SlideViewerProps) {
    ...
    <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-sm">
      ...
      <div className="absolute top-0 left-0 right-0 bg-gradient-to-b from-black/80 to-transparent p-6 z-10">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-white text-xl font-semibold mb-1">{topic.title}</h2>
      ...
      <div className="flex items-center justify-center h-full pt-20 pb-24 px-6">
        ...
        {/* Slide Image */}
        <div className={`relative max-w-full max-h-full transition-transform duration-300 ${isZoomed ? "scale-150 cursor-move" : "cursor-default"}`}>
          <Image
