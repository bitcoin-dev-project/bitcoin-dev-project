...
export function Navigation({
  ...
  return (
    ...
    <nav className={clsx('text-base lg:text-sm', className, 'w-64')}>
      ...
      <a className="mb-6 flex flex-row items-center space-x-3 hover:no-underline" href="/topics">
        <div className="h-11 w-1 rounded-lg bg-[#e77429]">
        </div>
        <div>
          <h6 className="mt-1 font-bold text-xl">Learn</h6>
          <div className="text-gray-600">Bitcoin, Privacy &amp; Decentralization</div>
        </div>
      </a>
