...
const FooterComponent = () => {
    ...
    return (
        <footer className={clsx("relative min-h-[944px] md:min-h-[1000px] lg:min-h-[766px] pt-12 lg:pt-16 bg-cover bg-bottom bg-no-repeat lg:bg-cover", isDecoding ? "bg-vscode-background-dark bg-dark-footer-mobile md:bg-dark-footer" : "bg-brand bg-footer-mobile md:bg-footer")}>
                        ...
                        {link.name !== "contact" && (
                            <div
                                className={clsx(
                                    ...
                                    isDecoding ? "text-gray-300" : "text-brand-dark"
                                )}
                            >
                            ...
                            <div className="flex flex-row gap-3 mt-2.5">
                                {link.links.map((subLink) => (
                                    <a
                                        ...
                                        className={clsx("border rounded-[6px] w-[52px] h-[52px] flex items-center justify-center transition-all duration-200 hover:scale-110",
                                            isDecoding 
